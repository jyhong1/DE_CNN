...
dir_path = "./DE_CNN/result/"+with_or_without+"/"
model_name = "CNN"
...
fill_cells(dir_path+"1234/",0,"θ+α+β+γ",arousal_or_valence)

out_book.save("./DE_CNN/result/summary/acc_"+with_or_without+"_"+arousal_or_valence+".xls")
print("end")